...
Namespace Entidades
    ...
    Partial Public Class ConfiguracionRemito
        Public Property IdConfiguracionRemito As Integer
        ...
        Public Property CantidadBultosTOP As Nullable(Of Integer)
        Public Property CantidadBultosLEFT As Nullable(Of Integer)
        Public Property CantidadBultosWIDTH As Nullable(Of Integer)
        ...
        Public Property TransporteNombreTOP As Integer
        Public Property TransporteNombreLEFT As Integer
        Public Property TransporteNombreWIDTH As Integer
        Public Property TransporteDomicilioTOP As Integer
        Public Property TransporteDomicilioLEFT As Integer
        Public Property TransporteDomicilioWIDTH As Integer
        Public Property TransporteTelefonoTOP As Integer
        Public Property TransporteTelefonoLEFT As Integer
        Public Property TransporteTelefonoWIDTH As Integer
        Public Property TransporteObservacionTOP As Integer
        Public Property TransporteObservacionLEFT As Integer
        Public Property TransporteObservacionWIDTH As Integer
